...
FEITO PELO MONGO (Baixei um ODBC do mongo que funcionou, mas vi que haviam outras possibilidades por um QVSource)
...
FEITO (Assumi que isso seria uma transformação, então coloquei como transformador)
...
- Total Geral de empresas; FEITO
- Total de empresas matrizes; FEITO
- Total de empresas filiais; FEITO
- Total de empresas optantes pelo simples e simei; (OBS: este ponto não entedi se era para somar o total de simples com total de simei, por este motivo fiz dois totatlizadores separados) FEITO

- Total de empresas públicas; FEITO 
- Total de empresas privadas; FEITO
- Total de empresas ativas; FEITO
- Total de empresas baixadas; FEITO
- Total de empresas mistas; FEITO
- Empresas por UF -> Município (Drilldown); FEITO
- Empresas em um gráfico de mapa; FEITO

- Empresas por faixa de veículos (leves + pesados) -> 0 a 5, 6 a 10, 11 a 15, 16 a 30, 31 a 50, > 50;  FEITO
- Filtro de empresas com veículos registrados na antt; FEITO
- Filtro de empresas optantes pelo simples (sim e não); FEITO
- Filtro de empresas optantes pelo simei (sim e não); FEITO

- Empresas por nível e atividade; FEITO
- Empresas por data de abertura; FEITO
- Empresas por Ramos de Atividade (do arquivo Setores e Ramos de Atividade); FEITO
- Empresas por CNAE Principal (tabela, onde CNAE principal tem número de ordem = 0) FEITO
